  ...
  // 传奇1.70版的装备, 共13个
{
  ...
  SM_NEWMAP = 51;             // 新地图
  SM_ABILITY = 52;            // 能力
  SM_HEALTHSPELLCHANGED = 53; // 红血蓝血 改变
  ...
  SM_NEEDUPDATE_ACCOUNT = 531;  // 需要更新, 说明
...
type
  ...
  TMonInfo = record
    ...
    wMAC: Word;         // MAC 魔法防御力
    wDC: Word;          // DC 攻击力
    wMaxDC: Word;       // DCMAX 攻击力上限
    wMC: Word;          // MC 魔法攻击力
    wSC: Word;          // SC 道士精神力
    wSpeed: Word;       // SPEED 速度
    wHitPoint: Word;    // HIT 攻击命中率
    wWalkSpeed: Word;   // Walk-SPD 行走速度间隔
    wWalkStep: Word;    // WalkStep 行走步伐
    wWalkWait: Word;    // WalkWait 行走等待时间
    wAttackSpeed: Word; // ATTACR-SPD 攻击速度间隔
    wAntiPush: Word;
    boAggro: Boolean;
    boTame: Boolean;
  end;
